...
bool actuacionJugador(unsigned char celda_inicial, unsigned char celda_fin, Action accion, unsigned int x, unsigned int y)
{
  ...
  case actTURN_R:
    cout << "La acción actTURN_R no es una acción elegible por el agente para esta práctica. Revisa tu código\n";
    salida = true;
    break;
  ...
  case actOVERTURN_R:
    ...
    monitor.girarJugadorDerecha(135);
    salida = true;
    break;


  case actTURN_L:
    cout << "La acción actTURN_L no es una acción elegible por el agente para esta práctica. Revisa tu código\n";
    salida = true;
    break;
  ...
  case actOVERTURN_L:
    ...
    monitor.girarJugadorIzquierda(135);
    salida = true;
    break;
